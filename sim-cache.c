/* 933343343
   Xintong Wang*/
/* All the changes are marked by "l3c"
...
static struct cache_t *cache_il3 = NULL; //l3c
...
/* level 3 data cache */
static struct cache_t *cache_dl3 = NULL; //l3c
...
{
  //l3c
  if (cache_dl3) /* if l3 cache exists, return */
    {
      /* access next level of data cache hierarchy */
...
{
  //l3c
  if (cache_il3) /* if l3 cache exists, return */
    {
      /* access next level of inst cache hierarchy */
...
static char *cache_dl3_opt /* = "none" */;  //l3c
static char *cache_il1_opt /* = "none" */;
static char *cache_il2_opt /* = "none" */;
static char *cache_il3_opt /* = "none" */;  //l3c
